...
#Configura a chave de API da OpenAI - Provavelmente após postar no GitHub a própria OpenAI tornará a chave inválida
client = OpenAI(
    api_key = "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",
)
